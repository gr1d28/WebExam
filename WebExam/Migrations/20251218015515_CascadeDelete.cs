        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserAnswers_ExamSessions_ExamSessionId",
                        column: x => x.ExamSessionId,
                        principalTable: "ExamSessions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SelectedAnswerOptions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SelectedAnswerOptions_AnswerOptions_AnswerOptionId",
                        column: x => x.AnswerOptionId,
                        principalTable: "AnswerOptions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SelectedAnswerOptions_UserAnswers_UserAnswerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExamSessions_UserId_ExamId_Status",
                table: "ExamSessions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SelectedAnswerOptions_AnswerOptionId",
                table: "SelectedAnswerOptions",
                column: "AnswerOptionId");

            migrationBuilder.CreateIndex(
                name: "IX_SelectedAnswerOptions_UserAnswerId_AnswerOptionId",
                table: "SelectedAnswerOptions",
                columns: new[] { "UserAnswerId", "AnswerOptionId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_UserAnswers_ExamSessionId",
                table: "UserAnswers",
                column: "ExamSessionId");

            migrationBuilder.CreateIndex(
                name: "IX_UserAnswers_ExamSessionId_QuestionId",
                table: "UserAnswers",
